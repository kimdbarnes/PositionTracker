...
class PositionController {
    ...
    def mapPosition = {
       assert params.id
       def positionInstance = Position.get(params.id)
       assert positionInstance
       def trackInstance = positionInstance.track
       assert trackInstance
       render(view: "mapPosition", model: 
          [trackInstance: trackInstance, positionInstance: positionInstance])
    }
}
